function results = fit_gonogo_fmincon(data)
    ...
    param(8).ub = 1.5;
        ...
        % Pavlovian bias  for win trials
    param(9).name = 'rs';
    param(9).logpdf = @(x) 0;  % uniorm prior
    param(9).lb = -20; % lower bound
    param(9).ub = 20;   % upper bound
    
    
    % Pavlovian bias for lose trials
    param(10).name = 'la';
    param(10).logpdf = @(x) 0;  % uniorm prior
    param(10).lb = -20; % lower bound
    param(10).ub = 20;   % upper bound
